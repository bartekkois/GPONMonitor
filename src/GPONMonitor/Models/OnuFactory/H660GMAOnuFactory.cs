...
{
    public class H660GMAOnuFactory : OnuFactory
    {
        public H660GMAOnuFactory(IResponseDescriptionDictionaries responseDescriptionDictionaries, IMapper mapper, IDataService snmpDataService) : base(responseDescriptionDictionaries, mapper, snmpDataService) { }

        public override IOnuFactory BuildOnu(uint oltId, uint oltPortId, uint onuId)
        {
            H660GMAOnu onu = _mapper.Map<H660GMAOnu>(base.BuildOnu(oltId, oltPortId, onuId));
