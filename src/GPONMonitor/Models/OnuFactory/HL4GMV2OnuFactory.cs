...
{
    public class HL4GMV2OnuFactory : OnuFactory
    {
        public HL4GMV2OnuFactory(IResponseDescriptionDictionaries responseDescriptionDictionaries, IMapper mapper, IDataService snmpDataService) : base(responseDescriptionDictionaries, mapper, snmpDataService) { }

        public override IOnuFactory BuildOnu(uint oltId, uint oltPortId, uint onuId)
        {
            HL4GMV2Onu onu = _mapper.Map<HL4GMV2Onu>(base.BuildOnu(oltId, oltPortId, onuId));
