...
{
    public class HL4GMVOnuFactory : OnuFactory
    {
        public HL4GMVOnuFactory(IResponseDescriptionDictionaries responseDescriptionDictionaries, IMapper mapper, IDataService snmpDataService) : base(responseDescriptionDictionaries, mapper, snmpDataService) { }

        public override IOnuFactory BuildOnu(uint oltId, uint oltPortId, uint onuId)
        {
            HL4GMVOnu onu = _mapper.Map<HL4GMVOnu>(base.BuildOnu(oltId, oltPortId, onuId));
