...
namespace GPONMonitor.Services
{
    public class ResponseDescriptionDictionaries : IResponseDescriptionDictionaries
    {
        ...
        public ResponseDescriptionDictionaries(IStringLocalizer<ResponseDescriptionDictionaries> localizer)
        {
            ...
            {
                { 1, new ResponseDescription(_localizer["none"], SeverityLevel.Info) },
                { 2, new ResponseDescription(_localizer["dying gasp (DGI)"], SeverityLevel.Info) },
                { 3, new ResponseDescription(_localizer["loss of signal (LOSI)"], SeverityLevel.Info) },
                { 4, new ResponseDescription(_localizer["loss of frame (LOFI)"], SeverityLevel.Info) },
                { 5, new ResponseDescription(_localizer["signal fail (SFI)"], SeverityLevel.Info) },
                { 6, new ResponseDescription(_localizer["start-up failure (SUFI)"], SeverityLevel.Info) },
                { 7, new ResponseDescription(_localizer["loss of PLOAM (LOAI)"], SeverityLevel.Info) },
                { 8, new ResponseDescription(_localizer["loss of PLOAM (LOAMI)"], SeverityLevel.Info) },
                { 9, new ResponseDescription(_localizer["loss of key sync (LOKI)"], SeverityLevel.Info) },
                { 10, new ResponseDescription(_localizer["admin reset"], SeverityLevel.Info) },
                { 11, new ResponseDescription(_localizer["admin active change"], SeverityLevel.Info) },
                { 12, new ResponseDescription(_localizer["admin olt configuration"], SeverityLevel.Info) },
                { 13, new ResponseDescription(_localizer["admin slot restart"], SeverityLevel.Info) },
                { 14, new ResponseDescription(_localizer["admin slot remove"], SeverityLevel.Info) },
                { 15, new ResponseDescription(_localizer["admin rogue onu candidate"], SeverityLevel.Info) },
                { 16, new ResponseDescription(_localizer["admin rogue onu"], SeverityLevel.Info) },
                { 17, new ResponseDescription(_localizer["admin rogue onu self detect block"], SeverityLevel.Info) },
                { 18, new ResponseDescription(_localizer["admin tx off optic"], SeverityLevel.Info) },
                { 19, new ResponseDescription(_localizer["admin deactivate"], SeverityLevel.Info) },
                { 20, new ResponseDescription(_localizer["admin olt deactivate"], SeverityLevel.Info) },
                { 21, new ResponseDescription(_localizer["admin omcc down"], SeverityLevel.Info) },
                { 22, new ResponseDescription(_localizer["admin set redundancy"], SeverityLevel.Info) },
                { 23, new ResponseDescription(_localizer["admin remove onu"], SeverityLevel.Info) },
                { 100, new ResponseDescription(_localizer["loss of signal (LOS)"], SeverityLevel.Info) },
