    ...
    public class DataService : IDataService
    {
        ...
        public async Task<IOnuFactory> GetOnuStateAsync(uint oltId, uint oltPortId, uint onuId)
        {
            return (await GetStringPropertyAsync(oltId, SnmpOIDCollection.snmpOIDGetOnuModelType + "." + oltPortId + "." + onuId)) switch
            {
                ...
                "H660GM-A" => new H660GMAOnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
                ...
                "HL-4BX3V-F" => new HL4BX3VFOnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
                "HL-4GQVS" => new HL4GQVSOnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
                "HL-4GQVS2" => new HL4GQVS2OnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
                ...
                "HL-4GXV-F" => new HL4GXVFOnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
                ...
                "HL-1B" => new HL1BOnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
                ...
                "HL-1GC" => new HL1GCOnuFactory(_responseDescriptionDictionaries, _mapper, this).BuildOnu(oltId, oltPortId, onuId),
